...
public class ApplicationController {
  ...
  @Operation(
      ...
      parameters = {
        ...
        @Parameter(
            name = "options",
            description = "选项设置（可不填）",
            required = true,
            schema = @Schema(type = "String")),
        @Parameter(
            name = "dynamicProperties",
            description = "动态参数（可不填）",
            required = true,
            schema = @Schema(type = "String")),
        @Parameter(
            name = "resolveOrder",
        ...
        @Parameter(
            name = "k8sPodTemplate",
            description = "k8s Pod模版",
            required = true,
            schema = @Schema(type = "String")),
        @Parameter(
            name = "k8sHadoopIntegration",
            description = "是否启用Hadoop配置",
            required = false,
        ...
        @Parameter(
            ...
            schema = @Schema(type = "String")),
        @Parameter(
            name = "k8sRestExposedType",
            description = "k8s服务对外类型",
            required = true,
            schema = @Schema(type = "String")),
        @Parameter(
            name = "teamId",
  ...
  @Operation(
      summary = "optionlog 操作日志 查JobManager URL",
      parameters = {
        @Parameter(
            name = "appId",
            description = "作业id",
  ...
  @Operation(summary = "upload 上传jar包")
  @PostMapping("upload")
  @RequiresPermissions("app:create")
